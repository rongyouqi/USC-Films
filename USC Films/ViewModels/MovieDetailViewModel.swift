...
class MovieDetailViewModel: ObservableObject {
    ...
    func fetchDetail(id: Int) {
        ...
        AF.request(url+"/6/"+String(id), encoding: JSONEncoding.default).responseJSON { response6 in
            ...
            case .success(let value6):
                ...
                AF.request(url+"/8/"+String(id), encoding: JSONEncoding.default).responseJSON { response8 in
                    ...
                    case .success(let value8):
                        ...
                        AF.request(url+"/10/"+String(id), encoding: JSONEncoding.default).responseJSON { response10 in
                            ...
                            case .success(let value10):
                                ...
                                AF.request(url+"/11/"+String(id), encoding: JSONEncoding.default).responseJSON { response11 in
                                    ...
                                    case .success(let value11):
                                        ...
                                        AF.request(url+"/9/"+String(id), encoding: JSONEncoding.default).responseJSON { response9 in
